...
export const variableAddToSelectGroup = createAction('[Variable] Add To Select Group', props<{ variableID: string }>());
...
export const groupSelected = createAction('[Group] Change Selected', props<{ groupID: string }>());

/* LOCAL CHANGES */
// Create variable groups and list of variables for easy access and change
export const datasetCreateMetadata = createAction('[Create Variables and Init Groups] Init groups and variables', props<{ data: any }>());
// Variable group created successfully
export const datasetCreateMetadataSuccess = createAction('[Create Variables and Init Groups] Success', props<{ groups: any[], variables: Variables }>());
// Variable group could not created
export const datasetCreateMetadataError = createAction('[Create Variables and Init Groups] Error', props<{ error: any }>());
// Variable group created successfully for this ID
export const datasetGroupVariablesUpdatedSuccess = createAction('[Create Group Variables] Success', props<{ groupID: any, variables: Variables, other: any }>());
// Variable group could not created
export const datasetGroupVariablesUpdatedError = createAction('[Create Group Variables] Error', props<{ error: any }>());
// Variable group could not created
export const datasetGroupVariablesUpdatedWarning = createAction('[Create Group Variables] Warning', props<{ message: string }>());
